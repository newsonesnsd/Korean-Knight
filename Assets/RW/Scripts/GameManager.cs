        ...
        void Start()
        {
            ...
            if (PlayerManager.LocalPlayerInstance == null)
            {
                if (PhotonNetwork.IsMasterClient)
                {
                    ...
                    player1 = PhotonNetwork.Instantiate("Car", player1SpawnPosition.transform.position
                        , player1SpawnPosition.transform.rotation, 0);
                    
                    ball = PhotonNetwork.Instantiate("Ball", ballSpawnTransform.transform.position
                        , ballSpawnTransform.transform.rotation, 0);
                    ball.name = "Ball";
                }
                else
                {
                    player2 = PhotonNetwork.Instantiate("Car", player2SpawnPosition.transform.position
